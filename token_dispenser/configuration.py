"""
This module provides application level configuration parameter values.
"""
import os
...
# Default value for token alive time in seconds. If token alive time is shorter than this value,
# then refresh before return
DEFAULT_TOKEN_MIN_ALIVE_SECS: int = 300
MINIMUM_ALIVE_SECS: int = int(os.getenv('MINIMUM_ALIVE_SECS', str(DEFAULT_TOKEN_MIN_ALIVE_SECS)))
# Maximum value of client requested minimum_alive_secs.
# If client requesting minimum_alive_secs too close to 3600 secs, it will cause the program
# to refresh token too
